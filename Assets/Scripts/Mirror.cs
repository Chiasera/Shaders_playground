...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class Mirror : MonoBehaviour
    {
        ...
        private void UpdateReflectionCamera(Camera realCamera)
        {
            ...
            pos = transform.position + Vector3.up * m_planeOffset;
            normal = transform.up;
        ...
        private Vector3 ReflectPosition(Vector3 pos)
        {
        ...
        private Camera CreateMirrorObjects()
        {
            ...
            var t = GameObject.Find("Camera").transform;
        ...
        private void ExecutePlanarReflections(ScriptableRenderContext context, Camera camera)
        {
            ...
            renderer.sharedMaterial.SetTexture("_PlanarReflectionTexture", _reflectionTexture);
        }
